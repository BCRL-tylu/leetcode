<h2><a href="https://leetcode.com/problems/maximum-coins-from-k-consecutive-bags">Maximum Coins From K Consecutive Bags</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>There are an infinite amount of bags on a number line, one bag for each coordinate. Some of these bags contain coins.</p>
